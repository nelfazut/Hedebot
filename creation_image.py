...
async def generate_scoreboard(src:list, iteration:int=0, *, show_before_saving:bool=False) -> None:
    """
    ...
    draw.line((FIRST_LINE,0, FIRST_LINE,IMAGE_HEIGHT), fill=LINES_COLOR, width=LINES_WIDTH)
